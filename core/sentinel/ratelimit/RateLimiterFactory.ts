...
export class RateLimiterFactory {
     ...
     * @private
     */
    private static readonly RATE_LIMITER_CACHE: Map<string, RateLimiter> = new Map<string, RateLimiter>();

    static {
        const tokenBuketRateLimiter: RateLimiter = new TokenBuketRateLimiter(Constant.TOKEN_BUKET_CAPACITY, Constant.TOKEN_BUKET_RATE);
